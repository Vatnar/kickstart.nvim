return {
			...
			clangd = {
				...
				root_dir = function(fname)
					return require("lspconfig.util").root_pattern(
					    ...
					    or require("lspconfig.util").root_pattern("compile_commands.json",
	...
	config = function(_, opts)
		...
		-- Servers you want to ensure installed
		local ensure_installed = vim.tbl_keys(opts.servers or {})

		-- mason-tool-installer (CLI tools)
		require("mason-tool-installer").setup {
			ensure_installed = ensure_installed,
		}

		-- mason-lspconfig setup (LSP servers)
		require("mason-lspconfig").setup {
			ensure_installed = ensure_installed, -- <- use the same list
